...
if __name__ == "__main__":
  ...
  img = input_fn(mnist.train.images, train_labels, batch_size=FLAGS.batch_size, rotate=FLAGS.rotation)
  ...
  # get score
  score = model.evaluate(x_test, mnist.test.labels, verbose=1)
  print("")
