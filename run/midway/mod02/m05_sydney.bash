...
#03 3bands
#04 6bands + 7layer
#05 6bands + 128dim output


# set parameter
band='28_29_31'  # tmp/alt band for cloud top feature extraction
EXPNAME='sydney_2000_2018_band'${band} # name of experiment & outputdirectory

# set directory
BASEFOLDER=/home/sydney/clouds # where you have your clouds directory
MODEL_PATH=/project2/foster/clouds/output/mod02/${SLURM_JOB_NAME}_${EXPNAME} #
DATA=/project/foster/clouds/data/MOD02/clouds_laads_preprocessed_2000_2018_band${band}/"*".tfrecord
...
python $BASEFOLDER/reproduction2/train.py $MODEL_PATH \
    --data $DATA \
    --max_steps 5 \
    --save_every 1 \
    --summary_every 1 \
